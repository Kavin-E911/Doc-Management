export default function Analytics({ stats, loading }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
      <div className={`bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg p-6 text-white shadow-lg hover:shadow-xl transition ${loading ? 'animate-pulse' : ''}`}>
      ...
      <div className={`bg-gradient-to-br from-green-500 to-green-600 rounded-lg p-6 text-white shadow-lg hover:shadow-xl transition ${loading ? 'animate-pulse' : ''}`}>
      ...
      <div className={`bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg p-6 text-white shadow-lg hover:shadow-xl transition ${loading ? 'animate-pulse' : ''}`}>
      ...
      <div className={`bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg p-6 text-white shadow-lg hover:shadow-xl transition ${loading ? 'animate-pulse' : ''}`}>
